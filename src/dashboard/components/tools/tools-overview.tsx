...
export function ToolsOverview({ onToolSelect, category = 'overview' }: ToolsOverviewProps) {
  const tools: Tool[] = [
    ...
    {
      id: 'remove-background-advanced',
      name: 'Remove Background Advanced',
      title: 'AI Background Remover',
      description: 'Remove background from images using advanced AI models',
      category: 'image',
      icon: (
        <div className="w-4 h-4 bg-indigo-600 rounded-lg flex items-center justify-center">
          <svg
            viewBox="0 0 24 24"
            fill="white"
            className="w-3 h-3"
